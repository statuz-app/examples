...
# Attach folder action (right-click folder → Folder Actions Setup)
# Test: copy any image to ~/Desktop/SocialExport - Statuz opens automatically
```
...
More examples coming soon. Check back or [contribute your own](https://github.com/statuz-app/examples)!
